...
fun levelButtonBackground(isSelected: Boolean) =
...
val AuthContainerStyle = CssStyle.base {
    Modifier
        .width(400.px)
        .padding(2.cssRem)
}

val AuthHeaderTitleStyle = CssStyle.base {
    Modifier
        .fontSize(2.5.cssRem)
        .fontWeight(FontWeight.Bold)
...
val AuthHeaderSubtitleStyle = CssStyle.base {
    Modifier
        .fontSize(1.5.cssRem)
        .fontWeight(FontWeight.Bold)
}

val AuthFormStyle = CssStyle.base {
    Modifier.fillMaxWidth()
}

val AuthInputStyle = CssStyle.base {
    Modifier
        .fillMaxWidth()
        .padding(0.8.cssRem)
        .borderRadius(8.px)
...
val AuthErrorStyle = CssStyle.base {
    Modifier
        .fontSize(0.9.cssRem)
        .textAlign(TextAlign.Center)
...
val AuthSubmitButtonStyle = CssStyle.base {
    Modifier
        .fillMaxWidth()
        .padding(0.8.cssRem)
        .borderRadius(8.px)
...
val AuthToggleContainerStyle = CssStyle.base {
    Modifier.fillMaxWidth()
}

val AuthToggleTextStyle = CssStyle.base {
    Modifier
        .fontSize(0.9.cssRem)
        .opacity(0.8)
}

val AuthToggleButtonStyle = CssStyle.base {
    Modifier
...
val SpinnerCenteredContainerStyle = CssStyle.base {
    Modifier
        .fillMaxWidth()
        .display(DisplayStyle.Flex)
}

// CustomAlert Component Styles
val AlertOverlayStyle = CssStyle.base {
    Modifier
...
val AlertMessageStyle = CssStyle.base {
    Modifier
        .fontSize(1.1.cssRem)
        .color(Colors.White)
        .textAlign(TextAlign.Center)
...
val AlertCancelButtonStyle = CssStyle.base {
    Modifier
        .padding(0.8.cssRem)
        .borderRadius(8.px)
...
val AlertConfirmButtonStyle = CssStyle.base {
    Modifier
        .padding(0.8.cssRem)
        .borderRadius(8.px)
        .backgroundColor(Colors.DeepSkyBlue)
...
val FeedbackTitleStyle = CssStyle.base {
    Modifier
        .fontSize(1.2.cssRem)
        .fontWeight(FontWeight.Bold)
}

val FeedbackMessageStyle = CssStyle.base {
    Modifier
        .fontSize(1.1.cssRem)
        .fontWeight(FontWeight.Bold)
        .margin(1.cssRem, 0.px)
...
// GameModeSelector Component Styles
val GameModeLoadingTextStyle = CssStyle.base {
    Modifier
        .fontSize(0.9.cssRem)
        .opacity(0.7)
}

val GameModeSelectorTitleStyle = CssStyle.base {
    Modifier.fontSize(1.1.cssRem)
}

val GameModeButtonStyle = CssStyle.base {
    Modifier
...
// Helper function for game mode button background
fun getGameModeButtonBackground(isSelected: Boolean, currentMode: GameMode?) =
    Modifier.backgroundColor(if (isSelected) ColorUtil.WhiteOp3 else ColorUtil.WhiteOp1)
        .let { mod ->
            if (isSelected) mod.border(2.px, LineStyle.Solid, ColorUtil.WhiteOp5)
            else mod.border(1.px, LineStyle.Solid, ColorUtil.WhiteOp2)
...
// GameStats Component Styles
val GameStatsRowStyle = CssStyle.base {
    Modifier
        .fillMaxWidth()
...
// LevelSelector Component Styles
val LevelSelectorTitleStyle = CssStyle.base {
    Modifier.fontSize(1.1.cssRem)
}

val LevelButtonTextStyle = CssStyle.base {
    Modifier.color(Color.white)
}

// QuestionArea Component Styles
val QuestionAreaContainerStyle = CssStyle.base {
    Modifier
        .fillMaxWidth()
        .padding(2.cssRem)
        .background(ColorUtil.WhiteOp1)
...
val QuestionPromptStyle = CssStyle.base {
    Modifier
        .fontSize(1.2.cssRem)
        .opacity(0.9)
        .margin(1.cssRem, 0.px)
...
val HomePageTitleStyle = CssStyle.base {
    Modifier
        .fontSize(2.5.cssRem)
        .fontWeight(FontWeight.Bold)
        .textShadow(2.px, 2.px, 4.px, rgba(0, 0, 0, 0.3))
